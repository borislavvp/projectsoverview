...
export const withPdfManager = () => {
    ...
    const isDocumentSelected = computed(() => selectedDocument.value.name !== undefined);

    const documentsLoaded = computed(() => (pdfManager.documents.length / pdfManager.numberOfBlobs)*100);
